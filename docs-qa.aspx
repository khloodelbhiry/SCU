<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="docs-qa.aspx.cs" Inherits="docs_qa" %>
                ...
                <div class="col-md-5" id="divControls" runat="server">
                   ...
                   <div class="col-lg-12 form-group">
                    ...
                    <div class="col-md-12 text-left fix">
                        <div class="clearfix"></div>
                        <asp:Button ID="btnSave" runat="server" CssClass="btn btn-sm btn-danger" Text="تمت مراجعة الوثيقة" OnClick="btnSave_Click" ValidationGroup="vgSave" />
                    </div>
