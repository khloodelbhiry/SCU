<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="doc-types.aspx.cs" Inherits="DocumentTypes" %>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-lg-12 text-left form-group">
                        ...
                        <asp:Button ID="btnNewDocumentType" Visible="false" runat="server" OnClick="btnNewDocType_Click" CausesValidation="false" CssClass="btn btn-sm btn-danger" Text="اضافة جديدة" />
            ...
            <asp:Label ID="lblResult" runat="server" Text="0"></asp:Label></h1>
                    ...
                    <asp:GridView ID="gdvData" Font-Size="Large" CssClass="table table-hover table-responsive" runat="server" AllowPaging="True" AllowSorting="true" OnSorting="gdvData_Sorting" AutoGenerateColumns="false" PageSize="30" EmptyDataText="لا يوجد بيانات" OnPageIndexChanging="gdvData_PageIndexChanging" Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="حذف" ItemStyle-Width="10" Visible="false">
                                <ItemTemplate>
