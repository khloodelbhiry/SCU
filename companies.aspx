                    ...
                    <asp:GridView ID="gdvData" Font-Size="Large" CssClass="table table-hover table-responsive" runat="server" AllowPaging="True" AllowSorting="True" OnSorting="gdvData_Sorting" AutoGenerateColumns="False" PageSize="30" EmptyDataText="لا يوجد بيانات" OnPageIndexChanging="gdvData_PageIndexChanging" Width="100%">
                        <Columns>
                            <asp:TemplateField HeaderText="الاسم ">
                                <ItemTemplate>
                                    <a href='<%# "company-users.aspx?id="+EncryptString.Encrypt(Eval("id").ToString()) %>'><%# Eval("name") %></a>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="حذف" ItemStyle-Width="10">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkDelete" CausesValidation="False" runat="server" Visible='<%# Eval("statusId").ToString()=="1" %>' CommandArgument='<%# Eval("id") %>' OnCommand="lnkDelete_Command" ToolTip="حذف" OnClientClick="return confirm('هل أنت متأكد من اتمام الحذف؟');"><img src="App_Themes/images/delete.png" width="25" height="25" /></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle CssClass="center" />
                            </asp:TemplateField>
                        </Columns>
