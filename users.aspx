<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="users.aspx.cs" Inherits="project_users" meta:resourcekey="PageResource1" %>
            ...
            <div class="page-content">
                ...
                <asp:GridView ID="gdvData" CssClass="table" runat="server" PageSize="50" AllowSorting="True" OnSorting="gdvData_Sorting" OnPageIndexChanging="gdvData_PageIndexChanging" Font-Size="Medium" Width="100%" AllowPaging="True" AutoGenerateColumns="False" SkinID="Professional" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" meta:resourcekey="gdvDataResource1">
                    <Columns>
                        ...
                        <asp:BoundField DataField="unit" HeaderText="الإدارة" SortExpression="unit" />
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6 form-group">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <asp:RequiredFieldValidator SetFocusOnError="True" ID="rfvElecM" runat="server" ControlToValidate="txtElecM" ValidationGroup="vgSubmit" ForeColor="Red" meta:resourcekey="rfvEmailRegResource1">*</asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 form-group">
                                            <label class="col-lg-4">الإدارة</label>
                                            <div class="col-lg-8">
                                                <asp:DropDownList ID="ddlUnit" CssClass="form-control" runat="server" meta:resourcekey="ddlGroupResource1"></asp:DropDownList>
                                                 <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlUnit" InitialValue="0" ValidationGroup="vgSubmit" ForeColor="Red" meta:resourcekey="rfvEmailRegResource1">*</asp:RequiredFieldValidator>
                                           </div>
                                        </div>
                                        <div class="col-lg-6 form-group">
