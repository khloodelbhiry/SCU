<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="project-consumables.aspx.cs" Inherits="issues" meta:resourcekey="PageResource1" %>
                        ...
                        <div id="id_issues" class="tab-pane active">
                            <asp:Panel runat="server" ID="Panel1">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <asp:DropDownList ID="ddlStatusSrc" CssClass="form-control" runat="server">
                                                <asp:ListItem Value="0" Text="-- اختر --" Selected="True"></asp:ListItem>
                                                <asp:ListItem Value="1" Text="قيد الأستلام"></asp:ListItem>
                                                <asp:ListItem Value="2" Text="مستلم"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                            ...
                            <asp:GridView ID="gdvData" CssClass="table" runat="server" PageSize="50" AllowSorting="True" OnSorting="gdvData_Sorting" OnPageIndexChanging="gdvData_PageIndexChanging" Font-Size="Medium" Width="100%" AllowPaging="True" AutoGenerateColumns="False" SkinID="Professional" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" meta:resourcekey="gdvDataResource1">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="quantity" HeaderText="الكمية" SortExpression="quantity" />
