<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="project-parties.aspx.cs" Inherits="DocumentTypes" %>
    ...
    <asp:UpdatePanel runat="server" ID="upnl">
        <ContentTemplate>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-lg-12 text-left form-group">
                                                        ...
                                                        <asp:Button ID="btnNew" runat="server" OnClick="btnNew_Click" CausesValidation="false" CssClass="btn btn-sm btn-danger" Text="اضافة جديدة" />
            ...
            <asp:Label ID="lblResult" runat="server" Text="0"></asp:Label></h1>
                                            ...
                                            <asp:ModalPopupExtender ID="mpeObject" TargetControlID="hdfObject" BackgroundCssClass="modal modal-st-erorr" PopupControlID="pnlObject" runat="server">
