<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="company-users.aspx.cs" Inherits="project_users" meta:resourcekey="PageResource1" %>
                        ...
                        <div id="id_users" class="tab-pane active">
                            <asp:Panel runat="server" ID="Panel1" meta:resourcekey="Panel1Resource1">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <asp:TextBox ID="txtElecMSrc" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label class="col-lg-5 control-label">
                                        ...
                                        <div class="col-lg-7">
                                            <asp:DropDownList ID="ddlProjectSrc" CssClass="form-control" runat="server" meta:resourcekey="ddlUnitSrcResource1"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label class="col-lg-5 control-label">
                            ...
                            <asp:GridView ID="gdvData" CssClass="table" runat="server" PageSize="50" AllowSorting="True" OnSorting="gdvData_Sorting" OnPageIndexChanging="gdvData_PageIndexChanging" Font-Size="Medium" Width="100%" AllowPaging="True" AutoGenerateColumns="False" SkinID="Professional" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" meta:resourcekey="gdvDataResource1">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="project" HeaderText="المشروع" SortExpression="project" />
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-6 form-group">
                                                        <label class="col-lg-4">المشروع</label>
                                                        <div class="col-lg-8">
                                                            <asp:DropDownList ID="ddlProject" CssClass="form-control" runat="server" meta:resourcekey="ddlUnitResource1"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="col-lg-6 form-group">
                                                    ...
                                                    <div class="col-lg-6 form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <asp:TextBox ID="txtElecM" runat="server" CssClass="form-control"></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="revEmail" SetFocusOnError="True" runat="server" ControlToValidate="txtElecM" ErrorMessage="تأكد من ادخال البريد الألكترونى بشكل صحيح" ValidationGroup="vgSubmit" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ForeColor="Red" meta:resourcekey="revEmailResource1">تأكد من ادخال البريد الألكترونى بشكل صحيح</asp:RegularExpressionValidator>
                            ...
                            <asp:Panel ID="pnlProject" runat="server" CssClass="index">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 style="text-align: right; margin: 0px;">
                                                <asp:LinkButton ID="lnkCloseProject" runat="server" Text="إغلاق" class="pull-left" OnClick="lnkCloseProject_Click" meta:resourcekey="btnCloseResource1"></asp:LinkButton></h3>
                                        </div>
                                        <div class="modal-body" style="max-height: 500px; overflow-y: auto;">
                                            <div class="row">
                                                <div class="col-lg-12 form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <asp:DropDownList ID="ddlProjectAssign" runat="server" CssClass="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
