<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="project-categories.aspx.cs" Inherits="ministers_departments" %>
                                    ...
                                    <div class="tab-content">
                                        <div id="home3" class="tab-pane active">
                                                    ...
                                                    <asp:Panel ID="pnlSubmit" runat="server" DefaultButton="lnkSubmit">
                                                        <div class="form-horizontal widget-box">
                                                            ...
                                                            <div class="col-md-12 text-left fix">
                                                                ...
                                                                <asp:Button ID="btnClear" runat="server" CssClass="btn btn-sm btn-inverse" Text="جديد" OnClick="btnClear_Click" />
                                                            </div>
                                            ...
                                            <div class="col-sm-7 icon-caret ace-icon tree-minus pull-left">
                                                <asp:TreeView ID="tvMenu" runat="server" Font-Size="Large" OnSelectedNodeChanged="tvMenu_SelectedNodeChanged" ExpandDepth="0" PopulateNodesFromClient="true" ShowLines="true" ShowExpandCollapse="true" OnTreeNodePopulate="tvMenu_TreeNodePopulate" />
                                            </div>
                                <div class="clearfix"></div>
                                        </div>
                                    </div>
